  ...
  channel.join()
    .receive('ok', () => {
      ...
      channel.push('tool_call', { 
        call_id: callId, 
        tool: 'report_blocker', 
        args: { space_id: '019d40e0-c421-7976-8a83-9c3fd4074eba', task_id: '019d3fd3-0d95-70ba-ad86-271e7f06a759', stage_id: '019d40fc-f5d4-7e70-a7bb-f8c68cf7d0b5', description: "CI failed on PR branch due to unrelated backend test failures in Platform.Orchestration.TaskRouterWatcher" } 
      });
    })
