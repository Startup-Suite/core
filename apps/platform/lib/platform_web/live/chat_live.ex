defmodule PlatformWeb.ChatLive do
  ...
  def render(assigns) do
    ...
    <div class="flex h-full overflow-hidden">
      <%!-- Desktop sidebar --%>
      <aside class="hidden lg:flex relative flex-shrink-0 flex-col border-r border-base-300 bg-base-200" phx-hook="ResizableSidebar" id="chat-sidebar">
        <%!-- Channels section --%>
        ...
        <div data-drag-handle class="absolute right-0 inset-y-0 w-1 cursor-col-resize hover:bg-primary/40 active:bg-primary/60 transition-colors z-10" aria-hidden="true"></div>
      </aside>
